...
describe('acetic acid cell loads and PBC enabled', () => {
  ...
  test('cell parsed, monoclinic, and showCell enabled', () => {
    ...
    const a = viewer.state.cell.a,
      b = viewer.state.cell.b,
      c = viewer.state.cell.c;
    const ax = Math.hypot(a.x, a.y, a.z),
      bx = Math.hypot(b.x, b.y, b.z),
      cx = Math.hypot(c.x, c.y, c.z);
