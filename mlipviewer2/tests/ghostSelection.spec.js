...
function sceneStub(){ return { onPointerObservable:{ add(){} }, pick(){ return { hit:false }; } }; }

describe('ghost atoms/bonds are not pickable', () => {
  test('toggle cell + ghosts and ensure picking still only returns real atoms', () => {
    const st = createMoleculeState({ elements:['C','H'], positions:[{x:0,y:0,z:0},{x:1,y:0,z:0}], bonds:[{i:0,j:1}], cell:{ a:{x:5,y:0,z:0}, b:{x:0,y:5,z:0}, c:{x:0,y:0,z:5}, enabled:true, originOffset:{x:0,y:0,z:0} } });
