...
test('page load starts MD and energy advances', async ({ page, baseURL }) => {
  ...
  await page.addInitScript(() => { window.__MLIPVIEW_SERVER = 'http://127.0.0.1:8000'; });
  await page.goto(`${baseURL}/index.html`);

  await page.waitForFunction(() => !!window.viewerApi && !!window.__MLIP_DEFAULT_LOADED, { timeout: 20000 });
