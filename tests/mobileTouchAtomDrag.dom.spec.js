...
if (!BABYLON.Vector3) {
  BABYLON.Vector3 = class V3 {
    ...
    subtract(o) {
      return new BABYLON.Vector3(this.x - o.x, this.y - o.y, this.z - o.z);
    }
    add(o) {
      return new BABYLON.Vector3(this.x + o.x, this.y + o.y, this.z + o.z);
    }
...
describe.skip('mobile: atom drag via touch', () => {
  ...
  function mkScene(canvas, camera) {
    return {
      ...
      createPickingRay() {
        return { origin: new BABYLON.Vector3(0, 0, -10), direction: new BABYLON.Vector3(0, 0, 1) };
      },
