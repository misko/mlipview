...
class Mesh {
  ...
  refreshBoundingInfo(){}
  getBoundingInfo(){ return this._boundingInfo; }
}
class TransformNode {
  constructor(name){ this.name=name; this.position=new Vector3(); this.scaling=new Vector3(1,1,1); this._children=[]; }
  getChildMeshes(){ return this._children; }
  addChild(m){ m.parent=this; this._children.push(m); }
}
