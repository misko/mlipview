...
beforeAll(() => {
  ...
  global.BABYLON = {
    Engine: function (canvas) {
      ...
      this.stopRenderLoop = () => {};
      this.getRenderingCanvas = () => canvas;
    },
    Scene: function () {
    ...
    Color3: function (r, g, b) {
      ...
      this.g = g;
      this.b = b;
      this.clone = () => new global.BABYLON.Color3(r, g, b);
      this.scale = (k) => new global.BABYLON.Color3(r * k, g * k, b * k);
    },
  ...
  global.BABYLON.Quaternion = function (x, y, z, w) {
    this.x = x || 0;
    this.y = y || 0;
    this.z = z || 0;
    this.w = w || 1;
...
describe.skip('desktop mouse orbit rotation', () => {
  test('dragging the mouse updates alpha/beta and not radius', async () => {
    ...
    canvas.dispatchEvent(
      new PointerEvent('pointerdown', { bubbles: true, clientX: 150, clientY: 150 })
    );
    canvas.dispatchEvent(
      new PointerEvent('pointermove', { bubbles: true, clientX: 200, clientY: 170 })
    );
