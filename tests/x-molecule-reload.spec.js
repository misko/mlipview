/**
 * Port of molecule reload flow checks: ensure URL params stick and the selector drives navigation.
 */

describe('x-molecule-reload', () => {
  test('buildReloadUrl preserves existing params while adding mol', async () => {
  ...
  test('installMoleculeSelector assigns window.location with mol param on change', async () => {
  ...
  test('loadDefault loads ?mol= resource when present', async () => {
    jest.resetModules();
