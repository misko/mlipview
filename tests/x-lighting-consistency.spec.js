...
if (!BABYLON.HemisphericLight) {
  BABYLON.HemisphericLight = class {
...
if (!BABYLON.DirectionalLight) {
  BABYLON.DirectionalLight = class {
    constructor(name, dir) {
      this.name = name;
      this.direction = dir;
      this.intensity = 1;
...
describe('lighting consistency', () => {
  test('creates ambient and headlight with configured intensities', () => {
    ...
    const handle = attachConsistentLighting(scene, camera, {
