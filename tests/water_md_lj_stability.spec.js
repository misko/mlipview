...
// 250-step LJ MD stability test: ensure coordinates remain finite and bounded.
...
describe('LJ MD 250-step stability', () => {
  test('LJ 250 steps stable', async () => {
    ...
    for(let step=0; step<250; step++){
      ...
      expect(maxD).toBeLessThan(10.0); // explosion threshold
    }
  }, 30000);
});
