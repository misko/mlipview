...
async function initViewer(){ window.__MLIPVIEW_TEST_MODE = true; window.__MLIPVIEW_SERVER='http://127.0.0.1:8000'; const canvas=document.createElement('canvas'); canvas.id='viewer'; document.body.appendChild(canvas); const energyDiv=document.createElement('div'); energyDiv.id='energyPlot'; document.body.appendChild(energyDiv); const c=document.createElement('canvas'); c.id='energyCanvas'; c.width=200; c.height=60; c.getContext=()=>({ clearRect(){}, beginPath(){}, moveTo(){}, lineTo(){}, stroke(){}, arc(){}, fill(){}}); energyDiv.appendChild(c); const label=document.createElement('div'); label.id='energyLabel'; energyDiv.appendChild(label); const mod = await import('../public/index.js'); return await mod.initNewViewer(canvas,{ elements:[{Z:8},{Z:1},{Z:1}], positions:[{x:0,y:0,z:0},{x:0.95,y:0,z:0},{x:-0.24,y:0.93,z:0}], bonds:[] }); }
