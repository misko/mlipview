...
if (!BABYLON.StandardMaterial) BABYLON.StandardMaterial = function(){ this.diffuseColor={clone:()=>({}), scale:()=>({})}; };
if (!BABYLON.Color3) BABYLON.Color3 = function(r,g,b){ this.r=r; this.g=g; this.b=b; this.scale = f=> new BABYLON.Color3(r*f,g*f,b*f); this.clone=()=>new BABYLON.Color3(r,g,b); };
...
function makeSceneStub(pickResultRef) {
  const scene = {
    ...
    onPointerObservable:{ add(fn){ this._fn=fn; }, _fn:null, simulateDown(){ this._fn && this._fn({ type: BABYLON.PointerEventTypes.POINTERDOWN }); } }
  };
  return scene;
}
