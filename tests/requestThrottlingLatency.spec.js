...
function makeViewerDom() {
  ...
  const instTemp = document.createElement('div');
  instTemp.id = 'instTemp';
  document.body.appendChild(instTemp);
  const rpsLabel = document.createElement('div');
  rpsLabel.id = 'rpsLabel';
  document.body.appendChild(rpsLabel);
  return canvas;
}
