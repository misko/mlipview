...
describe('precomputed injection (relax + md)', () => {
  test('includes precomputed energy/forces/stress when cache fresh; skips after geometry change', async () => {
    ...
    global.BABYLON = {
      ...
      Color3: function (r = 0, g = 0, b = 0) {
        this.r = r;
        this.g = g;
        this.b = b;
        this.clone = () => new global.BABYLON.Color3(this.r, this.g, this.b);
        this.scale = (s) => new global.BABYLON.Color3(this.r * s, this.g * s, this.b * s);
      },
      Color4: function () {},
    ...
    jest.unstable_mockModule('../public/render/moleculeView.js', () => ({
      createMoleculeView: () => ({ rebuildBonds: () => {} }),
    }));
