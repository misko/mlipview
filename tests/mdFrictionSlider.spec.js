...
global.fetch = async function(url, opts={}){
  if(typeof url === 'string' && /\/serve\/md$/.test(url)){
    ...
    const body = JSON.stringify({ positions:[[0,0,0],[0.96,0,0],[-0.24,0.93,0]], velocities:[[0,0,0],[0,0,0],[0,0,0]], forces:[[0,0,0],[0,0,0],[0,0,0]], final_energy: -1.0, steps_completed:1, temperature:(last.temperature||0) });
